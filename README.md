...
```bash
cd ai-fullstack-projects/viceme-skill-forge
npm install
npm run dev
```

Repeat the same commands inside the other project folders.

## Why These Fit The Role

- React frontend product flows with practical user-facing interactions.
- Node.js backend APIs with validation, domain logic, and mock AI services.
- AI-assisted workflows: generation, scoring, recommendations, and publishing checks.
- README files that explain product value, architecture, and interview talking points.
